...
class AppBarcodeScanner extends StatefulWidget {
  ...
  // const AppBarcodeScanner({Key? key, required this.onBarcodeScanned}) : super(key: key);
  const AppBarcodeScanner({Key? key}) : super(key: key);

  @override
  _AppBarcodeScannerState createState() =>
      _AppBarcodeScannerState();
}
...
class _AppBarcodeScannerState extends State<AppBarcodeScanner> {
  ...
  Future<void> onDetect(BarcodeCapture barcode) async {
    ...
    setState(() {
      ...
      // widget.onBarcodeScanned(barcode.toString());
    });
  }
